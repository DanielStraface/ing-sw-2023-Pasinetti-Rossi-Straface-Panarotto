...
class ColumnChecker extends CommonObjCard {
    public ColumnChecker(int numberOfPlayers){
...
class RowChecker extends CommonObjCard {
    public RowChecker(int numberOfPlayers){
        super(numberOfPlayers);
    }
